                ...
                <div className="flex flex-col text-left">
                    <span className="flex items-center mb-3">
                        ...
                        <p className="text-white">
                            Here you can monitor and manage all your data syncs. Each row represents a single sync task with its associated settings and status.
                        </p>
                            ...
                            {syncs.map((sync: Sync, index: number) => (
                                <div key={index} className="text-white px-5">
                                    <ul className="flex space-x-20 pb-4 text-base py-6 items-center border-b border-border-gray">
                                        ...
                                        <li className="w-24">{sync.version}</li>
                                        <li>
